...
function LineGraph:draw(dt)
	...
	love.graphics.print(string.format("%2.3fms", love.timer.getDelta()*1000), self.x, self.y - 60)
	love.graphics.setColor(255, 0, 0, 255)
	love.graphics.print(string.format("%2.3fms", self.target*1000), self.x, self.y - 40)
	love.graphics.setColor(0, 127, 0, 255)
	love.graphics.print(string.format("%2.3fms", self.average*1000), self.x, self.y - 20)
end
